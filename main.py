...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold cyan](11): Unlock Paid Cars + Siren [/bold cyan]")
            console.print("[bold cyan](12): Unlock w16 Engine [/bold cyan]")
            console.print("[bold cyan](13): Unlock All Horns [/bold cyan]")
            console.print("[bold cyan](14): Unlock Disable Damage [/bold cyan]")
            console.print("[bold cyan](15): Unlock Unlimited Fuel [/bold cyan]")
            console.print("[bold cyan](16): Unlock House 3 [/bold cyan]")
            console.print("[bold cyan](17): Unlock Smoke [/bold cyan]")
            console.print("[bold cyan](18): Change Race Wins [/bold cyan]")
            console.print("[bold cyan](19): Change Race Loses [/bold cyan]")
            console.print("[bold cyan](20): Clone Account [/bold cyan]")
            console.print("[bold cyan](21): Unlock all Cars [/bold cyan]")
            console.print("[bold cyan](22): Unlock Siren all Cars [/bold cyan]")
